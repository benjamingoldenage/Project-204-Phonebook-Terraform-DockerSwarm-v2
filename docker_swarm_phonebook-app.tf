...
locals {
  github-repo = "https://github.com/benjamingoldenage/Project-204-Phonebook-Terraform-DockerSwarm.git"
  github-file-url = "https://raw.githubusercontent.com/benjamingoldenage/Project-204-Phonebook-Terraform-DockerSwarm/master/"
}
